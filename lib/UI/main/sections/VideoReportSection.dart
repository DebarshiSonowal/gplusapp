...
class VideoReportSection extends StatelessWidget {
              ...
              itemBuilder: (cont, count) {
                ...
                if ((data.home_weekly.length > 4
                  ...
                  return GestureDetector(
                      onTap: () {
                        if (data.profile?.is_plan_active ?? false) {
                          logTheVideoReportClick(data.profile!, item.title!,
                          item.id!, item.publish_date!,);
  ...
  void logTheVideoReportClick(Profile profile, String heading,
      int thisId, String published_date,
      // String author_name
      ) async {
    // FirebaseAnalytics analytics = FirebaseAnalytics.instance;
    String id = await FirebaseAnalytics.instance.appInstanceId ?? "";
